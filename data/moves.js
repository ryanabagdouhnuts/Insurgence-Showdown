...
let BattleMovedex = {
	...
	"jetstream": {
		...
		shortDesc: "Until the end of the next turn, user's moves will have pritority.",
		id: "jetstream",
		name: "Jet Stream",
		pp: 30,
		priority: 0,
	...
	"lunarcannon": {
			...
			shortDesc: "Charges turn 1. Hits turn 2. Doesn't have to charge in New Moon.",
			id: "lunarcannon",
			name: "Lunar Cannon",
			pp: 10,
			priority: 0,
	...
	"nanorepair": {
			...
			shortDesc: "Heals the user by 50% of its max HP and raises def by 1.",
			id: "nanorepair",
			isViable: true,
			name: "Nanorepair",
			pp: 10,
	...
	"newmoon": {
		...
		shortDesc: "Boosts Ghost and Dark moves while weakening Fairy moves for 5 turns.",
		id: "newmoon",
		name: "New Moon",
		pp: 5,
		priority: 0,
	...
	"trickroom": {
		...
		effect: {
			...
			durationCallback(source, effect) {
				...
				if (source && source.hasItem('trickrock')) {
